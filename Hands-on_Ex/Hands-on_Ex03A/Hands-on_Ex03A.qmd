...
As the data is the same as previous exercise, I will skip checking the quality of data.
:::

# 2. Interactive Data Visualisation – ggiraph methods

[ggiraph](https://davidgohel.github.io/ggiraph/)![](images/ggiraph.jpg){width="35"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
If it used within a shiny application, elements associated with an id (data_id) can be selected and manipulated on client and server sides. Refer to this [article](https://www.ardata.fr/ggiraph-book/) for more detail explanation.
