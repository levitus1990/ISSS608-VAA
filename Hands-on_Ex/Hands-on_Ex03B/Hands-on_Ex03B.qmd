...
Unfortunately, `mutate_each` was deprecated in dplyr 0.7.0. and `funs()` was deprecated in dplyr 0.8.0. In view of this, we will re-write the code by using [mutate_at()](https://r4va.netlify.app/chap04) as shown in the code chunk below.
...
-   `enter` defines how new data should appear and how old data should disappear during the course of the animation.
