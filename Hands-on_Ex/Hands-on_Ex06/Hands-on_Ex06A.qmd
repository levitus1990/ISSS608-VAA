...
# Hands-on Exercise 6A - Modelling, Visualising and Analysing Network Data with R
...
![](image/edges_data.jpg)

### 2.2.2 The nodes data

-   *GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

![](image/nodes_data.jpg){width="591"}
...
### 2.2.8 Reviewing the revised edge files
...
![](image/ggraph_layouts.jpg)

![](image/ggraph_layouts2.jpg)
