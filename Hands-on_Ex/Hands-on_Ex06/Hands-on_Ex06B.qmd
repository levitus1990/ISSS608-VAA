...
# Hands-on Exercise 6B - Visualising and Analysing Text Data with R: tidytext methods
...
raw_text <- tibble(folder = 
  ...
  transmute(newsgroup = basename(folder), 
            id, text)
write_rds(raw_text, "chap29/rds/news20.rds")
...
![](image/tidytext_diagram.jpg)

### 3.1.1 Removing header and automated email signitures
...
### 3.1.2 Removing lines with nested text representing quotes from other users.

In this code chunk below, regular expressions are used to remove with nested text representing quotes from other users.3.2 The dplyr verbs in tidygraph:
...
### 3.1.4 Visualising words in newsgroups
...
![](image/idf%20formula.jpg){width="528"}

## 4.1 Computing tf-idf within newsgroups
...
## 4.2 Visualising tf-idf as interactive table
...
The code chunk uses `datatable()` of DT package to create a html table that allows pagination of rows and columns.
...
## 4.3 Visualising tf-idf within newsgroups
...
## 4.4 Counting and correlating pairs of words with the widyr package
...
![](image/widyr%20package.jpg){width="646"}
...
## 4.5 Visualising correlation as a network
...
## 4.10 Create a network graph from bigram data frame
...
## 4.11 Visualising a network of bigrams with ggraph
