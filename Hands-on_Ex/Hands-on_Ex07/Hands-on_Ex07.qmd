...
# Step 1: Install ggmosaic from GitHub (it's been removed from CRAN)
remotes::install_github("haleyjeppson/ggmosaic")

# Step 2: Now install CGPfunctions from GitHub
...
rice %>% 
  ...
  newggslopegraph(Year, Yield, Country,
                ...
                SubTitle = "1961-1980",
                Caption = "Prepared by: Ang Ming Kwan")
```
...
```{r}
# 1. Install ggstream directly from the author's GitHub
remotes::install_github("davidsjoberg/ggstream")

# 2. Test if it loads successfully
library(ggstream)
