...
**Interpretation:** Inland Urban dominates the portfolio by a wide margin. The Islands segment, while comprising approximately 24,000 policies, shows substantially wider confidence intervals in the loss ratio analysis (Section 10) than the inland segments — reflecting greater variability in loss outcomes within this segment rather than insufficient volume per se. Pricing decisions for this segment should treat the observed median loss ratio as an uncertain estimate with a wide range, not a reliable rate basis.
