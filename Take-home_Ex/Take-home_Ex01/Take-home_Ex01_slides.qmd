...
🔴 **COMP_N** (Comprehensive, No Excess):carries the most adverse risk profile of all product types.

🔴 **Bonus score**: stickiest policy holders with 75% remaining active.

🟠 **Short-duration policies**: systematically higher loss ratios suggesting claim-then-cancel behaviour; structural premium inadequacy
...
Also: New Businesses carries higher adverse risk vs portfolio renewals +++ Urban \> Rural loss ratios +++ Island pricing statistically unreliable
:::
:::::
...
⚠️ **Data quality finding:** It was noted that `age_driving_licence` was mentioned that it is the "Year in which the insured obtained the driving licence", but the dataset only provides 2 digits instead of 4 for this field, suggesting that there are errors in this column. As such, we will ignore this variable for our analyses.
:::
::::
:::::
...
**Interpretation:** **COMP_N carries the most adverse risk profile of all product types.**- carries the highest proportion of Bad bonus score policyholders (3.5% vs 1.0%–2.0% for other types) and its median loss ratio sits just above break-even. The combination of adverse selection in its risk intake and a median position above LR = 1 makes it the product type with the most concerning risk-profitability combination. Bonus scores show counterintuitive, statistically significant differences in loss ratios. "Good" policyholders exhibit the highest median loss ratio (~2.0) and widest spread. Further investigation is needed to check classification functionality or if "Good" policies hold higher absolute values.
:::
...
::: {style="font-size:0.91em; margin-top:4px; padding:5px 12px; background:#fef9e7; border-left:3px solid #c0392b; border-radius:3px;"}
**Interpretation:** **Luxury vehicles** exhibit a statistically confirmed but **small adverse selection signal** ($p < 0.001$), with a **higher "Bad" bonus proportion** (2.0% vs. ~1.2%) and **greater extreme claim cost variability**. Multivariate analysis is required to isolate independent predictive power.Glass Claims: **Glass claimers** show a bimodal annual claim frequency centered at 1.0 and 2.0 events, **overwhelmingly co-occurring with other claim types** rather than existing as isolated incidents.
:::
...
::: {style="font-size:0.91em; margin-top:4px; padding:5px 12px; background:#fef9e7; border-left:3px solid #c0392b; border-radius:3px;"}
**Interpretation:** **Bad-score policyholders are the stickiest cohort**. While they cancel more (25% vs. 10% for Good), **75% remain active**, representing the largest absolute risk retention because they likely lack external options. **Urban policies consistently generate higher median loss ratios** than rural ones. Meanwhile, island segments show wide confidence intervals due to low policy volumes; using their observed medians for pricing without accounting for this statistical unreliability introduces significant risk.
:::
