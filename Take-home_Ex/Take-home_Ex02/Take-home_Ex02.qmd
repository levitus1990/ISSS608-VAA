...
Together the two analyses address the leading indicator questions directly: one through statistical behavioural deviation, the other through content-based risk detection.

```{r}
# Rolling z-score of public posting rate per agent
...
This study applied visual analytics to reconstruct the embargo breach at TenantThread on June 5, 2046, examining the key events and decision points that led to the premature disclosure of Project HarborCrest, the behavioural norms that were violated, and the leading indicators that preceded the breach. 

Through six interconnected visualisations and a systematic analysis of near-miss communications, the investigation addressed the central legal question posed by CivicLoom's team: whether the embargo breach represented deliberate intent or systemic breakdown. **The evidence supports neither a clean deliberate leak nor a purely technical failure. The more precise characterisation is a pattern of deliberate individual decisions by key agents, operating within an oversight architecture that was structurally incapable of detecting or constraining those decisions.**

The breach was driven by a combination of external pressure and deliberate agent decisions. Section 5.1 established a 19% share price decline over the preceding two weeks, with sentiment deteriorating from Neutral to Critical, conditions under which agents increasingly prioritised reputational defence over compliance. On June 5, Legal-Agent initiated anonymous public posting at 9AM, eight hours before the embargo lifted, with PR-Intern and Social-Manager agents amplifying the disclosure through official and personal channels. Section 5.4 confirmed Legal-Agent as the first mover and primary escalation driver, while Section 5.5 revealed that Judge-Agent's compliance warning arrived at 3PM — six hours after the first violation and too late to prevent the breach.

Baseline analysis confirmed the breach was a categorical departure from established norms rather than a gradual escalation. Sections 5.2 and 5.3 showed that Legal-Agent had zero public channel activity across the entire baseline period, making its crisis-day anonymous posting a deliberate role-norm violation. Every posting action type in the dataset appeared exclusively on June 5, confirming the behaviour was qualitatively new.

Despite this, clear leading indicators had been accumulating for two weeks. From May 22 onwards, Platform-Trust-Agent was inferring the merger's existence from indirect signals and managing narrative framing without compliance response. The most significant precedent occurred on May 29, when Social-Manager-Agent publicly tagged CivicLoom's CEO with "Big things coming," receiving engagement from a CivicLoom staff account before deletion; a structural rehearsal of the June 5 breach. Legal-Agent's unilateral communication freezes on May 31 and June 1 further demonstrated the same pattern of role inversion that produced public posting on June 5.

These incidents produced no effective intervention due to three compounding failures: Legal-Agent deliberately briefed the compliance monitor without disclosing the counterparty identity, rendering it incapable of detecting the specific violations it was deployed to prevent; Platform-Trust-Agent prematurely declared containment without verifying knowledge propagation; and no oversight mechanism existed for Legal-Agent despite its concentration of both embargo knowledge and communications authority; a structural flaw confirmed by Section 5.6's network analysis.

The breach was therefore the foreseeable consequence of deliberate individual decisions accumulating within an oversight architecture incapable of constraining the agents most capable of causing harm, with direct relevance to CivicLoom's negligence and breach of representations and warranties claims against TenantThread.
